...
describe("CategoryFakerBuilder Unit Tests", () => {
  describe("categoryId prop", () => {
    ...
    test("should pass index to categoryId factory", () => {
      let mockFactory = vitest.fn(() => new Uuid());
      faker.withUuid(mockFactory);
      faker.build();
      expect(mockFactory).toHaveBeenCalledTimes(1);

      const categoryId = new Uuid();
      mockFactory = vitest.fn(() => categoryId);
  ...
  describe("name prop", () => {
    ...
    test("should call the word method", () => {
      const chance = Chance();
      const spyWordMethod = vitest.spyOn(chance, "word");
      faker["chance"] = chance;
      faker.build();
  ...
  describe("description prop", () => {
    ...
    test("should call the paragraph method", () => {
      const chance = Chance();
      const spyParagraphMethod = vitest.spyOn(chance, "paragraph");
      faker["chance"] = chance;
      faker.build();
